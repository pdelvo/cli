...
namespace Microsoft.DotNet.Tools.Publish
{
    public partial class PublishCommand
    {
        public static int Run(string[] args)
        {
            ...
            var buildBasePath = app.Option("-t|--temp-output <OUTPUT_DIR>", "Directory in which to place temporary outputs", CommandOptionType.SingleValue);
            ...
            app.OnExecute(() =>
            {
                ...
                publish.BaseBuildPath = buildBasePath.Value();
